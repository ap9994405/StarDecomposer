...
GraphModelGraphicsItem3::GraphModelGraphicsItem3(GraphModel *model, QGraphicsItem *parent)
...
GraphModelGraphicsItem3::~GraphModelGraphicsItem3()
{
    finalize();
}

void GraphModelGraphicsItem3::createInternels()
{
...
void GraphModelGraphicsItem3::createContainers()
{
...
void GraphModelGraphicsItem3::finalize()
{
    delete m_bondGroup ;
    delete m_factor ;
    delete m_tagItem ;
...
void GraphModelGraphicsItem3::createMolecule()
{
...
void GraphModelGraphicsItem3::createTag()
{
}

int GraphModelGraphicsItem3::getHeight()
{
    return boundingRect().height();
//    return rect().height();
}

int GraphModelGraphicsItem3::getWidth()
{
//    return rect().width();
    return boundingRect().width();
}

bool GraphModelGraphicsItem3::isHidden()
{
    return m_isHidden;
}

void GraphModelGraphicsItem3::setHidden(bool on)
{
    m_isHidden = on;
    setVisible(!m_isHidden);
}

void GraphModelGraphicsItem3::unselectBonds()
{
...
void GraphModelGraphicsItem3::selectBond(EdgeModel bond)
{
    unselectBonds();
...
GraphModel * GraphModelGraphicsItem3::getModel()
{
    return m_model;
}

QRectF GraphModelGraphicsItem3::boundingRect2()
{
...
void GraphModelGraphicsItem3::updateFactor(const QString &HTMLCode)
{
...
void GraphModelGraphicsItem3::createFactor()
{
...
void GraphModelGraphicsItem3::contextMenuEvent(QGraphicsSceneContextMenuEvent *event)
{

}

void GraphModelGraphicsItem3::hoverLeaveEvent(QGraphicsSceneHoverEvent *)
{

}

void GraphModelGraphicsItem3::hoverEnterEvent(QGraphicsSceneHoverEvent *)
{

}

void GraphModelGraphicsItem3::itemBondSelected(BondItem *bond)
{
    selectBond(bond->getEdgeModel());
}

void GraphModelGraphicsItem3::itemBondUnselected(BondItem *)
{
    unselectBonds();
}

void GraphModelGraphicsItem3::itemPolynomialChanged(GraphModel *model)
{
    updateFactor(model->getPoly().toHTML());
}

void GraphModelGraphicsItem3::itemStateChanged(GraphModel *)
{
        finalize();
        createContainers();
        createInternels();
...
void GraphModelGraphicsItem3::childTagChanged()
{
    updateItemPositions();
    updateBoundingRect();
    emit tagChanged();
...
void GraphModelGraphicsItem3::setTagVisible(bool visible)
{
...
void GraphModelGraphicsItem3::setShowTagWhenDisconnected(bool on)
{
...
void GraphModelGraphicsItem3::setShowMarker(bool value)
{
    if (m_selected_bond)
    {
...
bool GraphModelGraphicsItem3::isGridRotated()
{
    return m_isRotated;
}

void GraphModelGraphicsItem3::reset()
{
    delete m_bondGroup ;
    delete m_factor ;
    delete m_tagItem ;
...
void GraphModelGraphicsItem3::updateBoundingRect()
{
...
void GraphModelGraphicsItem3::setGridRotated(bool rotate)
{
...
void GraphModelGraphicsItem3::updateItemPositions()
{
    m_totalGroup->setPos(0,0);
...
void GraphModelGraphicsItem3::updatePath()
{
...
bool GraphModelGraphicsItem3::isMarkerShowed()
{
    return m_selected_marker->isVisible();
}

void GraphModelGraphicsItem3::updateTag()
{
    m_tagItem->setText(m_model->getFullTag());
}

void GraphModelGraphicsItem3::setBondSelectable(bool selectable)
{
...
void GraphModelGraphicsItem3::setAtomNumberVisible(bool visible)
{
...
void GraphModelGraphicsItem3::clearLink()
{
...
void GraphModelGraphicsItem3::addLink(const QList<QPair<int, int> > &links)
{
...
QPointF GraphModelGraphicsItem3::getMidPoint(const EdgeModel &edge) const
{
    return this->m_edge_bond_mapping[edge]->getMidPoint()+m_bondGroup->pos();
}

QPointF GraphModelGraphicsItem3::getStartPoint(const EdgeModel &edge) const
{
    return this->m_edge_bond_mapping[edge]->getStartPoint()+m_bondGroup->pos();
}

QPointF GraphModelGraphicsItem3::getEndPoint(const EdgeModel &edge) const
{
    return this->m_edge_bond_mapping[edge]->getEndPoint()+m_bondGroup->pos();
}


QList<QPointF> GraphModelGraphicsItem3::getRingPoints(const QList<EdgeModel> &edges) const
{
