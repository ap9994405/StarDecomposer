// This Header file is for ZZSPinpopulation2

#ifndef GRAPHMODELGRAPHITEM4_H
#define GRAPHMODELGRAPHITEM4_H
...
class GraphModelGraphicsItem4 : public QObject, public QGraphicsRectItem
{
    Q_OBJECT
    friend class GraphicsItemDebugDialog;
public:
    GraphModelGraphicsItem4(GraphModel* model, QGraphicsItem * parent = 0);
    bool isHidden();
