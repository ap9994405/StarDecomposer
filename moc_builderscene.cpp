...
QT_MOC_LITERAL(1, 13, 11), // "onMouseMove"
QT_MOC_LITERAL(2, 25, 0), // ""
QT_MOC_LITERAL(3, 26, 3) // "pos"

    },
    "BuilderScene\0onMouseMove\0\0pos"
};
...
void BuilderScene::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (BuilderScene::*_t)(QPointF );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&BuilderScene::onMouseMove)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject BuilderScene::staticMetaObject = {
    { &QGraphicsScene::staticMetaObject, qt_meta_stringdata_BuilderScene.data,
      qt_meta_data_BuilderScene,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *BuilderScene::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_BuilderScene.stringdata0))
        return static_cast<void*>(const_cast< BuilderScene*>(this));
...
// SIGNAL 0
void BuilderScene::onMouseMove(QPointF _t1)
{
