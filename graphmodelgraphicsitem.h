...
class GraphModelGraphicsItem : public QObject, public QGraphicsRectItem
{
    Q_OBJECT
    friend class GraphicsItemDebugDialog;
public:
    GraphModelGraphicsItem(GraphModel* model, QGraphicsItem * parent = 0);
    bool isHidden();
